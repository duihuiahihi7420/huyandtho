...
{
		$vProductName  = isset($_POST["name"]) ? $_POST["name"] : '';
        $vPrice 	= isset($_POST["price"]) ? $_POST["price"] : '';
        $pro_image = $_FILES["fileUpload"]["name"];
        $vMaunu_id = isset($_POST["manu"]) ? $_POST["manu"] : '';
        $vType_id = isset($_POST["type"]) ? $_POST["type"] : '';
        $vFeature = isset($_POST["feature"]) ? $_POST["feature"] : '';
       
	
		
        $vDescription 	= isset($_POST["description"]) ? $_POST["description"] : '';
        ...
        $pro = new Product();
        $vResult_Ins =  $pro->InsertProduct($vProductName,$vPrice,$pro_image,$vDescription,$vMaunu_id,$vType_id,$vFeature);
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <form action="" method="post" class="form-horizontal"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                    <?php 
                                        $category = new Protype;
                                       
                                        ?>
                                        <select name="type" id="" class="form-control" required>
                                            
                                            <?php 
                                            $getAllCate = $category->getAllProtype();
                                            foreach ($getAllCate as $key_cate => $value_cate) {
                                            ?>
                                            <option value="<?php echo $value_cate['type_id'] ?>"><?php echo $value_cate['type_name'] ?></option>
                                            <?php 
                                            } ?>
                                        </select>
                                    </div>
