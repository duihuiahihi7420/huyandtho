            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title"> <span class="icon"><a href="Manufacture/add.php"> <i class="icon-plus"></i>
                                </a></span>
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach ($manu->getALlmanuFacture_Page() as $value) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <a href="Manufacture/edit.php?manu_id=<?= $value['manu_id']?>" class="btn btn-success btn-mini">Edit</a>
                                            
                                            <a href="Manufacture/delete.php?manu_id=<?= $value['manu_id']?>" class="btn btn-danger btn-mini">Delete</a>
