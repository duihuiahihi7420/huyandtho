                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td width="250"><img
                                                src="../images/image/<?php echo $value['pro_image']?>" />
                                        </td>
                                        ...
                                        <td>
                                            <a href="Product/edit.php?ID=<?= $value['id']?>" class="btn btn-success btn-mini">Edit</a>
                                            <a href="Product/delete.php?id=<?= $value['id']?>" class="btn btn-danger btn-mini">Delete</a>
                                        </td>
                                    </tr>
                                    <?php }?>
