            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title"> <span class="icon"><a href="protype/add.php"> <i class="icon-plus"></i>
                                </a></span>
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php 
                                    $pro = new Protype;
                                    foreach ($pro->getAllProtype_Page() as $value) {
                                    ...
                                    <tr class="">
                                        ...
                                        <a href="protype/update.php?id=<?php echo $value['type_id']?>" class="btn btn-success btn-mini">Edit</a>   
                                                
                                        <a href="protype/delete.php?type_id=<?= $value['type_id']?>" class="btn btn-danger btn-mini">Delete</a>
                                        </td>
                                    </tr>
                                    <?php }?>
                                </tbody>
