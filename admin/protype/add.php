...
if(isset($_GET['type_name'])){
    ...
    $type = new Protype;
    $num = count($type->getProtypeByName($type_name));
    if($num > 0){
        
        $error = "Tên Đã Tồn Tại";
    }else{
        $sql = "INSERT INTO protypes(type_name) VALUES('$type_name')";
        $db = new Db();
        $db->SIUD($sql);
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <form action="" method="get">
                            ...
                            <input required class="form-control" type="text" name="type_name">
                            <div class="error">
                                <?php if(isset($error)) echo $error.'<br>';else echo "<br>" ?>  
                            </div>
                            <input class="btn btn-info" type="submit" value="Add Protypes">
                        </form>
                    </div>
                </div>
            </div>
